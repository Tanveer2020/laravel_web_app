                            ...
                            <div class="row align-items-center d-flex h-100">
                                <div class="col-md-12">
                                    <div class="block">
                                        ...
                                        <h1 class="mb-3 mt-3 text-center">{{$privacy->name}}</h1>                                                                                
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 align-items-center d-flex">
                        <div class="about-block">
                            <h1 class="title-color mb-3">{{$privacy->name}}</h1>
                            {!! $privacy->content !!}
                    ...
                    @if($privacy->image != null)
                        ...
                        <div class="image-red-background">
                            <img src="{{asset('uploads/pages/thumb/large/'.$privacy->image)}}" alt="" class="w-100">
                        </div>
