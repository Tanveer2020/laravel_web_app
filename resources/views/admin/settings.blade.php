                        ...
                        <div class="row">
                            ...
                            <div class="alert alert-success">
                               ...
                               @endif
                                ...
                                <form action="" method="post" name="settingsForm" id="settingsForm" enctype="multipart/form-data">
							    ...
							    <!-- <div class="card-header">
                                 ...
                                 <div class = "card-body">
                                   <div class="form-group">
                                   	...
                                   	<input type="text" name="website_title" value="{{(!empty($settings->website_title)) ? $settings->website_title : ''}}" id = "website_title" class="form-control">
                                    <p class="error website-title-error"></p>
                                   </div>
                                   <div class="form-group">
                                   	<label for="name">Email</label>
                                   	<input type="text" name="email" value="{{(!empty($settings->email)) ? $settings->email : ''}}" id = "email" class="form-control">
                                    
                                   </div>
                                   <div class="form-group">
                                   	<label for="name">Phone</label>
                                   	<input type="text" name="phone" value="{{(!empty($settings->phone)) ? $settings->phone : ''}}" id = "phone" class="form-control">
                                    
                                   </div>
                                   <div class="form-group">
                                    <label for="name">Copyright</label>
                                    <input type="text" name="copy" value="{{(!empty($settings->copy)) ? $settings->copy : ''}}" id = "copy" class="form-control">
                                   ...
                                   <div class="mt-4">
                                   	...
                                   	<input type="text" name="facebook_url" value="{{(!empty($settings->facebook_url)) ? $settings->facebook_url : ''}}" id = "facebook_url" class="form-control">
                                    
                                   </div>
                                   <div class="form-group">
                                   	<label for="name">Twitter Url</label>
                                   	<input type="text" name="twitter_url" value="{{(!empty($settings->twitter_url)) ? $settings->twitter_url : ''}}" id = "twitter_url" class="form-control">
                                    
                                   </div>
                                   <div class="form-group">
                                    <label for="name">Instagram Url</label>
                                    <input type="text" name="instagram_url" value="{{(!empty($settings->instagram_url)) ? $settings->instagram_url : ''}}" id = "instagram_url" class="form-control">
...
<script type="text/javascript">
  ...
  function addService(){
    ...
    var html = `<div class="ui-state-default" data-id = '${serviceId}' id = service-${serviceId}><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>${serviceName}
