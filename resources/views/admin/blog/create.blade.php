                    ...
                    <div class="container-fluid  h-100">
                        ...
                        <div class="row">
							<div class="col-md-12">
                                ...
                                <form action="" method="post" name="createBlog" id="createBlog" enctype="multipart/form-data">
							    ...
							    <div class="card-header">
                                 ...
                                 <div class = "card-body">
                                   ...
                                   <div class="col-md-6">
                                   	 ...
                                   	 <textarea name="short_description" id = "short_description" cols = "30" rows = "6" class="form-control"></textarea>
                                   </div>
                                   </div>
